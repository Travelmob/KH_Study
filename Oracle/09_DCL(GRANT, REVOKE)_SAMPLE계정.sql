...
-- 3-1. SAMPLE 계정에 테이블을 생성할 수 있는 권한이 없기 때문에 오류발생
...
-- SAMPLE계정에서 KH계정의 테이블에 접근해서 조회해보기
SELECT *
  FROM KH.EMPLOYEE;
-- 5. KH게정의 테이블에 접근해서 조회할 수 있는 권한이 없기 때문에 오류 발생
...
-- SAMPLE계정에서 KH계정의 테이블에 접근해서 INSERT해보기
