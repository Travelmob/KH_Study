...
-- 3_2. SAMPLE계정에 테이블 스페이스를 할당해주기(SAMPLE계정 변경)
ALTER USER SAMPLE QUOTA 2M ON SYSTEM;
-- 2M : 2Mega Byte

-- 4. SAMPLE계정에 뷰를 생성할 수 있는 CREATE VIEW권한 부여
...
-- 6. SAMPLE계정에 KH.DEPARTMENT테이블에 INSERT할 수 있는 권한 부여
GRANT INSERT ON KH.DEPARTMENT TO SAMPLE;
--------------------------------------------------------------------------------

-- 최소한의 권한을 부여합시다 ~ CONNECT, RESOURCE 만 부여
