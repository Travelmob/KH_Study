/*
    ...
    * 트랜잭션(TRANSACTION)   -> 작업단위
    ...
    COMMIT(확정)하기 전까지의 변경사항들을 하나의 트랜잭션으로 담게 됨
    ...
    * 트랜잭션의 종류
    ...
    - ROLLBACK; 진행 : 하나의 트랜잭션에 담겨있는 변경사항들 삭제한 후 마지막 COMMIT시점으로 돌아감
    - SAVEPOINT 포인트명; : 현재 이 시점에 임시저장점을 만들겠다.
    - ROLLBACK 포인트명; : 전체 변경사항을 날리는것이 아니라 해당 포인트 지점까지의 트랜잭션만 롤백하겠다.
*/
