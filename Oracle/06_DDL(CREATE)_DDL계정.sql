...
-->> 회원들의 데이터(아이디, 비밀번호, 이름, 회원가입일)를 담기위한 MEMBER 테이블 생성하기
...
-- INSERT INTO 테이블명 VALUES(첫번째 컬럼의 값, 두번째 컬럼의 값, 세번째 컬럼의값, ....);
INSERT INTO MEMBER VALUES('user01', 'pass01', '홍길동', '2023-02-28');
INSERT INTO MEMBER VALUES('user02', 'pass02', '홍닐동', '23/02/28');
INSERT INTO MEMBER VALUES('user03', 'pass03', '홍딜동', SYSDATE);
INSERT INTO MEMBER VALUES(NULL, NULL, NULL, SYSDATE); -- 아이디, 비밀번호, 이름에 NULL값이 존재해서는 안됨
INSERT INTO MEMBER VALUES('user03', 'pass04', '이승철', SYSDATE); -- 중복된 아이디가 들어가버림

-- 위의 NULL값 / 중복된 아이디값은 유효하지않은 값들!
...
/*
    1. NOT NULL 제약조건
    해당 컬럼에 반드시 값이 존재해야할 경우 사용(NULL 값이 절대 들어와서는 안되는 컬럼에 부여)
    INSERT / UPDATE 시 NULL값을 허용하지 않도록 제한

    단, NOT NULL제약조건은 컬럼레벨 방식으로만 부여가 가능
*/
...
VALUES(1, 'user01', 'pass01', '홍길동', '남', '010-1234-1234', sysdate);
INSERT INTO MEM_NOTNULL
VALUES(2, NULL, NULL, NULL, NULL, NULL, NULL); -- NOT NULL 제약조건 위배!! 오류 발생!!
INSERT INTO MEM_NOTNULL
VALUES(2, 'user02', 'pass02', NULL, NULL, NULL, NULL); -- NOT NULL제약조건이 부여되어있는 모든 컬럼에 반드시 값이 존재해야한다!!
INSERT INTO MEM_NOTNULL
VALUES(3, 'user01', 'pass02', NULL, NULL, NULL, NULL);
...
/*
    2. UNIQUE 제약조건
    컬럼에 중복값을 제한하는 제약조건
    INSERT / UPDATE 시 기존에 해당 컬럼값 중에 중복값이 있을 경우 추가 또는 수정이 되지않게 제약
...
INSERT INTO MEM_UNIQUE VALUES(1, 'user01', 'pass01', '홍길동', '남', '010-1234-1234', sysdate);
...
INSERT INTO MEM_UNIQUE VALUES(2, 'user02', 'pass03', '머시기', NULL, NULL, NULL);
...
INSERT INTO MEM_CHECK VALUES(2, 'user02', 'pass02', '이승철', '가', NULL, SYSDATE);

INSERT INTO MEM_CHECK VALUES(3, 'user03', 'pass03', '어쩌고', NULL, NULL, SYSDATE);
-- CHECK 제약조건에 NULL값도 INSERT가 가능(NULL값도 못들어오게 하고싶다면 NOT NULL제약조건도 부여하면됨!!)

SELECT * FROM MEM_CHECK;
-- 회원가입일을 항상 SYSDATE값으로 넣고싶은데.. 테이블에서 지정 가능!! -> 제약조건은 아님!!
...
/*
    ...
    => 중복되지않고 값이 존재해야만 하는 컬럼에 PRIMARY KEY부여(NOT NULL + UNIQUE)
...
-- PRIMARIKEY가 한 테이블에 두 개가 될 수 없다.
-- table can have only one primary key
-- 두 개의 컬럼을 하나로 묶어서 PRIMARY KEY하나로 설정 가능!
...
INSERT INTO MEM
VALUES(2, 'user02', 'pass02', '김길동', 'G2', NULL, NULL);
...
-- PARENT KEY NOT FOUND발생!!!
-- G4등급은 MEM_GRADE 테이블의 GRADE_CODE컬럼에서 제공하는 값이 아니기 때문에 오류 발생!!
-- ORA-02291: integrity constraint (DDL.SYS_C008155) violated - parent key not found
...
-- ORA-02292: integrity constraint (DDL.SYS_C008155) violated - child record found
...
/*
    * 테이블이 다 생성된 후 뒤늦게 제약조건 추가(ALTER TABLE 테이블명 XXXXXXXX)
...
-- EMPLOEE_COPY 테이블에 없은 PRIMARY KEY 제약조건 추가 EMP_ID 컬럼에
ALTER TABLE EMPLOYEE_COPY ADD PRIMARY KEY(EMP_ID);

-- EMPLOYEE 테이블에 DEPT_CODE 컬럼에 외래키 제약조건 추가(DEPARMENT 의 DEPT_ID를 참조)
ALTER TABLE EMPLOYEE ADD FOREIGN KEY(DEPT_CODE) REFERENCES DEPARTMENT(DEPT_ID);

-- EMPLOYEE테이블에 JOB_CODE 컬럼에 외래키 제약조건 추가(JOB의 JOB_CODE참조)
